...
0. Introduction	10
   ...
   1. Purpose of this Syllabus	10

   2. The Certified Tester Foundation Level in Software Testing	10

   3. Career Path for Testers	10

   4. Business Outcomes	11

   5. Examinable Learning Objectives and Cognitive Level of Knowledge	11

   6. The Foundation Level Certificate Exam	12

   7. Accreditation	12

   8. Handling of Standards	12

   9. Staying Current	12

   10. Level of Detail	12

   11. How this Syllabus is Organized	13

1. Fundamentals of Testing – 180 minutes	14

   1. [What is Testing?	15](#what-is-testing?)

      1. [Test Objectives	15](#test-objectives)

      2. [Testing and Debugging	16](#testing-and-debugging)

   2. Why is Testing Necessary?	16

      1. [Testing’s Contributions to Success	16](#testing’s-contributions-to-success)

      2. [Testing and Quality Assurance (QA)	17](#testing-and-quality-assurance-\(qa\))

      3. [Errors, Defects, Failures, and Root Causes	17](#errors,-defects,-failures,-and-root-causes)

   3. Testing Principles	17

   4. Test Activities, Testware and Test Roles	18

      1. [Test Activities and Tasks	18](#test-activities-and-tasks)

      2. [Test Process in Context	19](#test-process-in-context)

      3. [Testware	20](#testware)

      4. [Traceability between the Test Basis and Testware	20](#traceability-between-the-test-basis-and-testware)

      5. [Roles in Testing	21](#roles-in-testing)

   5. Essential Skills and Good Practices in Testing	21

      1. [Generic Skills Required for Testing	21](#generic-skills-required-for-testing)

      2. [Whole Team Approach	22](#whole-team-approach)

      3. [Independence of Testing	22](#independence-of-testing)

2. Testing Throughout the Software Development Lifecycle – 130 minutes	24

   1. Testing in the Context of a Software Development Lifecycle (SDLC)	25

      1. [Impact of the Software Development Lifecycle on Testing	25](#impact-of-the-software-development-lifecycle-on-testing)

      2. [Software Development Lifecycle and Good Testing Practices	25](#software-development-lifecycle-and-good-testing-practices)

      3. [Testing as a Driver for Software Development	26](#testing-as-a-driver-for-software-development)

      4. [DevOps and Testing	26](#devops-and-testing)

      5. [Shift Left	27](#shift-left)

      6. [Retrospectives and Process Improvement	28](#retrospectives-and-process-improvement)

   2. Test Levels and Test Types	28

      1. [Test Levels	28](#test-levels)

      2. [Test Types	29](#test-types)

      3. [Confirmation Testing and Regression Testing	30](#confirmation-testing-and-regression-testing)

   3. Maintenance Testing	31

3. Static Testing – 80 minutes	32

   1. [Static Testing Basics	33](#static-testing-basics)

      1. [Work Products Examinable by Static Testing	33](#work-products-examinable-by-static-testing)

      2. [Value of Static Testing	33](#value-of-static-testing)

      3. [Differences between Static Testing and Dynamic Testing	34](#differences-between-static-testing-and-dynamic-testing)

   2. Feedback and Review Process	35

      1. [Benefits of Early and Frequent Stakeholder Feedback	35](#benefits-of-early-and-frequent-stakeholder-feedback)

      2. [Review Process Activities	35](#review-process-activities)

      3. [Roles and Responsibilities in Reviews	36](#roles-and-responsibilities-in-reviews)

      4. [Review Types	36](#review-types)

      5. [Success Factors for Reviews	37](#success-factors-for-reviews)

4. Test Analysis and Design – 390 minutes	38

   1. [Test Techniques Overview	39](#test-techniques-overview)

   2. [Black-Box Test Techniques	39](#black-box-test-techniques)

      1. [Equivalence Partitioning	39](#equivalence-partitioning)

      2. [Boundary Value Analysis	40](#boundary-value-analysis)

      3. [Decision Table Testing	41](#decision-table-testing)

      4. [State Transition Testing	41](#state-transition-testing)

   3. White-Box Test Techniques	42

      1. [Statement Testing and Statement Coverage	42](#statement-testing-and-statement-coverage)

      2. [Branch Testing and Branch Coverage	43](#branch-testing-and-branch-coverage)

      3. [The Value of White-box Testing	43](#the-value-of-white-box-testing)

   4. Experience-based Test Techniques	43

      1. [Error Guessing	43](#error-guessing)

      2. [Exploratory Testing	44](#exploratory-testing)

      3. [Checklist-Based Testing	44](#checklist-based-testing)

   5. Collaboration-based Test Approaches	45

      1. [Collaborative User Story Writing	45](#collaborative-user-story-writing)

      2. [Acceptance Criteria	45](#acceptance-criteria)

      3. [Acceptance Test-driven Development (ATDD)	46](#acceptance-test-driven-development-\(atdd\))

5. Managing the Test Activities – 335 minutes	47

   1. [Test Planning	48](#test-planning)

      1. [Purpose and Content of a Test Plan	48](#purpose-and-content-of-a-test-plan)

      2. [Tester's Contribution to Iteration and Release Planning	48](#tester's-contribution-to-iteration-and-release-planning)

      3. [Entry Criteria and Exit Criteria	49](#entry-criteria-and-exit-criteria)

      4. [Estimation Techniques	49](#estimation-techniques)

      5. [Test Case Prioritization	50](#test-case-prioritization)

      6. [Test Pyramid	50](#test-pyramid)

      7. [Testing Quadrants	51](#testing-quadrants)

   2. Risk Management	51

      1. [Risk Definition and Risk Attributes	52](#risk-definition-and-risk-attributes)

      2. [Project Risks and Product Risks	52](#project-risks-and-product-risks)

      3. [Product Risk Analysis	52](#product-risk-analysis)

      4. [Product Risk Control	53](#product-risk-control)

   3. Test Monitoring, Test Control and Test Completion	53

      1. [Metrics used in Testing	54](#metrics-used-in-testing)

      2. [Purpose, Content and Audience for Test Reports	54](#purpose,-content-and-audience-for-test-reports)

      3. [Communicating the Status of Testing	55](#communicating-the-status-of-testing)

   4. Configuration Management	56

   5. Defect Management	56

6. Test Tools – 20 minutes	58

   1. [Tool Support for Testing	59](#tool-support-for-testing)

   2. [Benefits and Risks of Test Automation	59](#benefits-and-risks-of-test-automation)
...
FL-BO4	Assess and improve the quality of documentation FL-BO5	Increase the effectiveness and efficiency of testing

FL-BO6	Align the test process with the software development lifecycle FL-BO7	Understand test management principles  
FL-BO8	Write and communicate clear and understandable defect reports

FL-BO9	Understand the factors that influence the priorities and efforts related to testing FL-BO10	Work as part of a cross-functional team

FL-BO11	Know risks and benefits related to test automation FL-BO12	Identify essential skills required for testing
...
* Chapter 5: Managing the Test Activities (335 minutes)
  ...
  * The student learns how risks can influence the test scope.
...
FL-1.2.2	(K1) Recall the relation between testing and quality assurance FL-1.2.3	(K2) Distinguish between root cause, error, defect, and failure
...
FL-1.4.1	(K2) Explain the different test activities and related tasks FL-1.4.2	(K2) Explain the impact of context on the test process

FL-1.4.3	(K2) Differentiate the testware that supports the test activities FL-1.4.4	(K2) Explain the value of maintaining traceability

FL-1.4.5	(K2) Compare the different roles in testing

5. ### **Essential Skills and Good Practices in Testing**

FL-1.5.1	(K2) Give examples of the generic skills required for testing FL-1.5.2	(K1) Recall the advantages of the whole team approach  
...
1. ## Testing’s Contributions to Success {#testing’s-contributions-to-success}
...
2. ## Testing and Quality Assurance (QA) {#testing-and-quality-assurance-(qa)}
...
3. ## Errors, Defects, Failures, and Root Causes {#errors,-defects,-failures,-and-root-causes}
...
Defects can be found in documentation, such as a requirements specification or a test script, in source code, or in a supporting work product such as a build file. Defects in work products produced earlier in the SDLC, if undetected, often lead to defective work products later in the lifecycle. If a defect in code is executed, the system may fail to do what it should do, or do something it shouldn’t, causing a failure.
...
1. ## Test Activities and Tasks {#test-activities-and-tasks}
...
**Test implementation** includes creating or acquiring the testware necessary for test execution (e.g., test data). Test cases can be organized into test procedures, which are often assembled into test suites.

Manual and automated test scripts are created. Test procedures are prioritized and arranged within a test execution schedule for efficient test execution (see section 5.1.5). The test environment is built and verified to be set up correctly.
...
2. ## Test Process in Context {#test-process-in-context}
...
* **Test completion work products** include: test completion report (see section 5.3.2), action items for improvement of subsequent projects or iterations, documented lessons learned, and change requests (e.g., as product backlog items).
  ...
  4. ## Traceability between the Test Basis and Testware {#traceability-between-the-test-basis-and-testware}
...
5. ## Roles in Testing {#roles-in-testing}
...
1. ## Generic Skills Required for Testing {#generic-skills-required-for-testing}
...
2. ## Whole Team Approach {#whole-team-approach}
...
3. ## Independence of Testing {#independence-of-testing}
...
FL-2.1.1	(K2) Explain the impact of the chosen software development lifecycle on testing FL-2.1.2	(K1) Recall good testing practices that apply to all software development lifecycles FL-2.1.3	(K1) Recall the examples of test-first approaches to development

FL-2.1.4	(K2) Summarize how DevOps might have an impact on testing FL-2.1.5	(K2) Explain shift left  
FL-2.1.6	(K2) Explain how retrospectives can be used as a mechanism for process improvement

2. ### **Test Levels and Test Types**

FL-2.2.1	(K2) Distinguish the different test levels FL-2.2.2	(K2) Distinguish the different test types
...
1. ## Impact of the Software Development Lifecycle on Testing {#impact-of-the-software-development-lifecycle-on-testing}
...
2. ## Software Development Lifecycle and Good Testing Practices {#software-development-lifecycle-and-good-testing-practices}
...
* Test analysis and design for a given test level begins during the corresponding development phase of the SDLC, so that testing can adhere to the principle of early testing (see section 1.3)
  ...
  * Testers are involved in reviewing work products as soon as drafts of these work products are available, so that this earlier testing and defect detection can support shift left (see section 2.1.5).
    ...
    3. ## Testing as a Driver for Software Development {#testing-as-a-driver-for-software-development}
...
4. ## DevOps and Testing {#devops-and-testing}
...
* Automated processes are promoted like CI/CD that facilitates establishing stable test environments
  ...
  * The visibility on non-functional quality characteristics increases (e.g., performance efficiency, reliability)
    ...
    * The risk of regression is minimized due to the scale and range of automated regression tests DevOps is not without its risks and challenges, which include:
...
6. ## Retrospectives and Process Improvement {#retrospectives-and-process-improvement}
...
3. ## Confirmation Testing and Regression Testing {#confirmation-testing-and-regression-testing}
...
1. ### **Static Testing Basics** {#static-testing-basics}

FL-3.1.1	(K1) Recognize types of work products that can be examined by static testing FL-3.1.2	(K2) Explain the value of static testing  
FL-3.1.3	(K2) Compare and contrast static testing and dynamic testing

2. ### **Feedback and Review Process**

FL-3.2.1	(K1) Identify the benefits of early and frequent stakeholder feedback FL-3.2.2	(K2) Summarize the activities of the review process

FL-3.2.3	(K1) Recall which responsibilities are assigned to the principal roles when performing reviews FL-3.2.4	(K2) Compare and contrast the different review types
...
1. ## Work Products Examinable by Static Testing {#work-products-examinable-by-static-testing}
...
2. ## Value of Static Testing {#value-of-static-testing}
...
3. ## Differences between Static Testing and Dynamic Testing {#differences-between-static-testing-and-dynamic-testing}
...
1. ## Benefits of Early and Frequent Stakeholder Feedback {#benefits-of-early-and-frequent-stakeholder-feedback}
...
2. ## Review Process Activities {#review-process-activities}
...
* **Fixing and reporting.** For every defect, a defect report should be created so that corrective actions can be followed up. Once the exit criteria are reached, the work product can be accepted. The review results are reported.
  ...
  3. ## Roles and Responsibilities in Reviews {#roles-and-responsibilities-in-reviews}
...
* **Inspection.** As inspections are the most formal type of review, they follow the complete generic process (see section 3.2.2). The main objective is to find the maximum number of anomalies. Other objectives are to evaluate quality, build confidence in the work product, and to motivate and enable authors to improve. Metrics are collected and used to improve the SDLC, including the inspection process. In inspections, the author cannot act as the review leader or scribe.
  ...
  5. ## Success Factors for Reviews {#success-factors-for-reviews}
...
1. ### **Test Techniques Overview** {#test-techniques-overview}

   FL-4.1.1	(K2) Distinguish black-box test techniques, white-box test techniques and experience-based test techniques

   2. ### **Black-box Test Techniques** {#black-box-test-techniques}

FL-4.2.1	(K3) Use equivalence partitioning to derive test cases FL-4.2.2	(K3) Use boundary value analysis to derive test cases FL-4.2.3	(K3) Use decision table testing to derive test cases FL-4.2.4	(K3) Use state transition testing to derive test cases

3. ### **White-box Test Techniques**

FL-4.3.1	(K2) Explain statement testing FL-4.3.2	(K2) Explain branch testing
...
Test techniques support the tester in test analysis (what to test) and in test design (how to test). Test techniques help to develop a relatively small, but sufficient, set of test cases in a systematic way. Test techniques also help the tester to define test conditions, identify coverage items, and identify test data during the test analysis and design. Further information on test techniques can be found in the ISO/IEC/IEEE 29119-4 standard, and in (Beizer 1990, Craig 2002, Copeland 2004, Koomen 2006,  
...
* State Transition Testing
  ...
  1. ## Equivalence Partitioning {#equivalence-partitioning}
...
2. ## Boundary Value Analysis {#boundary-value-analysis}
...
In 2-value BVA (Craig 2002, Myers 2011), for each boundary value there are two coverage items: this boundary value and its closest neighbor belonging to the adjacent partition. To achieve 100% coverage with 2-value BVA, test cases must exercise all coverage items, i.e., all identified boundary values.
...
1. ## Statement Testing and Statement Coverage {#statement-testing-and-statement-coverage}
...
2. ## Branch Testing and Branch Coverage {#branch-testing-and-branch-coverage}
...
3. ## The Value of White-box Testing {#the-value-of-white-box-testing}
...
* Checklist-based testing
  ...
  1. ## Error Guessing {#error-guessing}
...
3. ## Checklist-Based Testing {#checklist-based-testing}
...
1. ## Collaborative User Story Writing {#collaborative-user-story-writing}
...
FL-5.1.2	(K1) Recognize how a tester adds value to iteration and release planning FL-5.1.3	(K2) Compare and contrast entry criteria and exit criteria

FL-5.1.4	(K3) Use estimation techniques to calculate the required test effort FL-5.1.5	(K3) Apply test case prioritization
...
FL-5.2.1	(K1) Identify risk level by using risk likelihood and risk impact FL-5.2.2	(K2) Distinguish between project risks and product risks

FL-5.2.3	(K2) Explain how product risk analysis may influence thoroughness and test scope FL-5.2.4	(K2) Explain what measures can be taken in response to analyzed product risks

3. ### **Test Monitoring, Test Control and Test Completion**

FL-5.3.1	(K1) Recall metrics used for testing

FL-5.3.2	(K2) Summarize the purposes, content, and audiences for test reports FL-5.3.3	(K2) Exemplify how to communicate the status of testing
...
1. ## Purpose and Content of a Test Plan {#purpose-and-content-of-a-test-plan}
...
2. ## Tester's Contribution to Iteration and Release Planning {#tester's-contribution-to-iteration-and-release-planning}
...
3. ## Entry Criteria and Exit Criteria {#entry-criteria-and-exit-criteria}
...
7. ## Testing Quadrants {#testing-quadrants}
...
1. ## Risk Definition and Risk Attributes {#risk-definition-and-risk-attributes}
...
2. ## Project Risks and Product Risks {#project-risks-and-product-risks}
...
* User dissatisfaction
  ...
  * Loss of revenue, trust, reputation
    ...
    * In extreme cases, physical damage, injuries or even death
    ...
    3. ## Product Risk Analysis {#product-risk-analysis}
...
* Determine the test scope to be carried out
  ...
  * Determine the particular test levels and propose test types to be performed
    ...
    * Determine whether any activities in addition to testing could be employed to reduce risk
    ...
    4. ## Product Risk Control {#product-risk-control}
...
1. ## Metrics used in Testing {#metrics-used-in-testing}
...
* Project progress metrics (e.g., task completion, resource usage, test effort)
  ...
  * Test progress metrics (e.g., test case implementation progress, test environment preparation progress, number of test cases run/not run, passed/failed, test execution time)
    ...
    * Cost metrics (e.g., cost of testing, organizational cost of quality)
    ...
    2. ## Purpose, Content and Audience for Test Reports {#purpose,-content-and-audience-for-test-reports}
...
3. ## Communicating the Status of Testing {#communicating-the-status-of-testing}
...
* Provide those responsible for handling and resolving reported defects with sufficient information to resolve the issue
  ...
  * Provide a means of tracking the quality of the work product
    ...
    * Provide ideas for improvement of the development and test process A defect report logged during dynamic testing typically includes:  
    * Unique identifier
...
1. ### **Tool Support for Testing** {#tool-support-for-testing}

FL-6.1.1	(K2) Explain how different types of test tools support testing

2. ### **Benefits and Risks of Test Automation** {#benefits-and-risks-of-test-automation}
...
* More time for testers to design new, deeper and more effective tests Potential risks of using test automation include:
...
| Chapter/ | Learning objective | K- | BUSINESS OUTCOMES |  |  |  |  |  |  |  |  |  |  |  |  |  |
| :---- | ----- | ----- | ----- | ----- | ----- | ----- | ----- | ----- | :---- | :---- | :---- | ----- | :---- | :---- | :---- | :---- |
| section/	level subsection |  |  | FL-BO1 | FL-BO2 | FL-BO3 | FL-BO4 | FL-BO5 | FL-BO6 | FL-BO7 | FL-BO8 | FL-BO9 | FL-BO10 | FL-BO11 | FL-BO12 | FL-BO13 | FL-BO14 |
...
| :---- | ----- | ----- | ----- | ----- | :---- | :---- | ----- | :---- | :---- | :---- | :---- | :---- | :---- | :---- | :---- | :---- |
| section/	level subsection |  |  | FL-BO1 | FL-BO2 | FL-BO3 | FL-BO4 | FL-BO5 | FL-BO6 | FL-BO7 | FL-BO8 | FL-BO9 | FL-BO10 | FL-BO11 | FL-BO12 | FL-BO13 | FL-BO14 |
| 4.1.1 | Distinguish black-box test techniques, white-box test techniques and experience- based test techniques | K2 |  | X |  |  |  |  |  |  |  |  |  |  |  |  |
...
* Size reduction of the overall syllabus. Syllabus is not a textbook, but a document that serves to outline the basic elements of an introductory course on software testing, including what topics should be covered and on what level. Therefore, in particular:
  ...
  * The “Syllabus writing checklist” was followed, which suggests the maximum text size for  
...
scribe (reviews), 36  
Scrum, 25  
SDLC, *See* software development lifecycle security, 30
...
skill, 21  
software development lifecycle, 25 specification, 30  
specification workshop, 46  
spiral model, 25

state table, 41  
state transition diagram, 41 state transition testing, 41 statement, 42  
statement coverage, 42

statement testing, 42  
static analysis, 27, 33

static testing, 15, 33, 43 static testing tool, 59 stub, 20  
...
test automation framework, 46 test basis, 19, 20, 29  
test case, 19, 20, 50  
test case prioritization, 50 test charter, 20, 44
...
test control, 19, 53 test coverage tool, 59 test data, 19, 20  
test design, 19, 26 test design tool, 59 test effort, 49  
test environment, 19, 20  
test execution, 19

test execution schedule, 19, 20 test execution tool, 59

test harness, 29  
test implementation, 19  
test implementation tool, 59 test level, 25, 28

test log, 20

test management role, 21 test metric, 54  
...
Unified Process, 25 unit test framework, 29 usability, 30  
user acceptance testing, 29 user story, 45  
V model, 25  
valid partition, 40

valid transitions coverage, 42 validation, 15, 33  
verification, 15, 33  
virtual machine, 59
...
white-box testing, 30 whole team approach, 22 Wideband Delphi, 50